...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 28, 2018 at 01:04 AM
...
ALTER TABLE `advisement`
  ADD CONSTRAINT `advisement_ibfk_1` FOREIGN KEY (`stu_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `advisement_ibfk_2` FOREIGN KEY (`adv_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
