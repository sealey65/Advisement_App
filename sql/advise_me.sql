...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2018 at 07:53 AM
...
INSERT INTO `advised_course` (`advised_course_id`, `course_code`, `advisement_id`, `approved`, `type`, `grade`) VALUES
(6, 'ITEC 133', 7, 0, 'Compulsory', 'A'),
(7, 'ITEC 240', 7, 0, 'Compulsory', 'B'),
(8, 'ITEC 120', 7, 0, 'Compulsory', 'B'),
(9, 'ITEC 122', 8, 0, 'Compulsory', 'B'),
(10, 'ITEC 260', 8, 0, 'Compulsory', 'C'),
(14, 'GRDE 129', 8, 0, 'Compulsory', '');
...
INSERT INTO `post` (`post_id`, `post_date`, `user_id`, `content`, `advisement_id`, `is_new`) VALUES
(5, '2017-09-05 08:15:06', '00055873', 'Hi Miss, is there a prereq for ITEC 229?', 8, 1),
(6, '2017-09-07 14:15:06', 'AD_Nagee', 'No there isn\'t.', 8, 1),
(7, '2017-06-08 08:15:06', '00055873', 'Hi Miss, can I do ITEC 270?', 7, 0),
(8, '2017-06-09 08:15:06', 'AD_Nagee', 'No, not yet. You have yet to do the prereq?', 7, 0);
...
('00052358', 'nick', 'singh', 'Part Time', 23, 'SGC'),
...
INSERT INTO `user` (`user_id`, `f_name`, `user_email`, `password_hash`, `role_name`) VALUES
('00000001', '', '00000001@my.costaatt.edu.tt', '$2y$10$4v7jjdL.pSl/h6dKf2JV8eCY3YHtE1fyE2rcl.YGj4ONZkixU8Z2a', 'Admin'),
('00052358', 'Nicholas', '00052358@my.costaatt.edu.tt', '$2y$10$XkyoSu4OHV2oRGIrESmf2uMXymIufOuZSSF7TE9yrppi9WT589Xti', 'Student'),
('00055873', 'Earl', '00055873@my.costaatt.edu.tt', '$2y$10$exOI/zFzLjbJRsLD76J/qupaNGB3FrezGBxDY71vUrRZtEFp6Cbxi', 'Student'),
('AD_Nagee', 'Alicia', 'AD_Nagee@my.costaatt.edu.tt', '$2y$10$exOI/zFzLjbJRsLD76J/qupaNGB3FrezGBxDY71vUrRZtEFp6Cbxi', 'Advisor'),
...
--
ALTER TABLE `advised_course`
  MODIFY `advised_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
